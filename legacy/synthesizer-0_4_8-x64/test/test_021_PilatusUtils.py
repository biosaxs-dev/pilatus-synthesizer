...
in_folder   = env_dict['in_folder_log_dx']
...
def test_get_data_info():
    ...
    eq_( info_array[0], ['001_d0_00000.tif', ['-10.70001', '6.00000'], 1.0, None, None]  )
    eq_( info_array[1], ['001_d1_00000.tif', ['5', '3'], 0.99969755489938661, None, None]  )
    eq_( info_array[2], ['001_d2_00000.tif', ['-5', '-3'], 0.99922484440879822, None, None]  )
