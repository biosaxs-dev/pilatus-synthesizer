...
in_folder   = env_dict['in_folder_cbf_tif']
...
def test_get_data_info():
    ...
    eq_( info_array[0], ['AgBh0_0_00000.tif', ['0.70000', '-0.35000'], 1.0, None, None]  )
    eq_( info_array[1], ['AgBh0_1_00000.tif', ['0', '0'], 0.99906009213162839, None, None] )
    eq_( info_array[2], ['AgBh0_2_00000.tif', ['0', '0'], 0.99870375343427875, None, None] )
