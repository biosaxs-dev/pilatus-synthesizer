...
in_folder   = env_dict['in_folder_new']
...
def test_get_data_info():
    ...
    eq_( info_array[0], ['ogu20160618S_air_0_d0_00000.tif', ['-17.10000', '178.60000'], 1.0, None, None] )
    eq_( info_array[1], ['ogu20160618S_air_0_d1_00000.tif', ['5', '5'], 0.99948285509016932, None, None] )
    eq_( info_array[2], ['ogu20160618S_air_0_d2_00000.tif', ['-5', '-5'], 1.0009495336756686, None, None] )
    info_array = data_array[ -1 ][ 1 ]
    eq_( info_array[0], ['ogu20160618S_air_41_d0_00000.tif', ['-17.10000', '178.60000'], 1.0, None, None] )
    eq_( info_array[1], ['ogu20160618S_air_41_d1_00000.tif', ['5', '5'], 1.001212392083682, None, None] )
    eq_( info_array[2], ['ogu20160618S_air_41_d2_00000.tif', ['-5', '-5'], 0.99997605688883218, None, None] )
