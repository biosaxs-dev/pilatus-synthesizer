...
from OurTkinter         import Tk, FileDialog, TkDND, ToolTip
...
class EntryFrame(Tk.Frame):
    ...
    def add_dnd_bind( self ):
        ...
        self.dnd.bindtarget( self.in_folder_entry,  dnd_handler_in_folder,  'text/uri-list' )
        self.dnd.bindtarget( self.log_file_entry,   dnd_handler_log_file,   'text/uri-list' )
        self.dnd.bindtarget( self.mask_file_entry,  dnd_handler_mask_file,  'text/uri-list' )
        if self.adj_output == 'YES':
            self.dnd.bindtarget( self.adj_folder_entry, dnd_handler_adj_folder, 'text/uri-list' )
        self.dnd.bindtarget( self.syn_folder_entry, dnd_handler_syn_folder, 'text/uri-list' )
