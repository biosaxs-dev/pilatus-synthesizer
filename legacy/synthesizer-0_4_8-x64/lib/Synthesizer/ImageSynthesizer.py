...
class ImageSynthesizer():
    ...
    def set_setting_info( self, action ):
        self.direction = get_setting('positive_direction')
        ...
        for sub_rec in exec_rec_array[1:]:
            ...
            if self.action == 1:
                ...
                if s_file != None:
                    ...
                    a_pim   = PilatusImage(s_path, self.mask_array, s_delta[0], s_delta[1], direction=self.direction)
                    a_im_array  = a_pim.image_array()
                else:
                    a_im_array  = None
    ...
    def exec_single_synthesis( self, sample_id, base_rec, fkey, sub_rec, isfinal ):
        ...
        a_pim   = PilatusImage(s_path, self.mask_array, s_delta[0], s_delta[1], i_ratio, a_ratio, direction=self.direction)
