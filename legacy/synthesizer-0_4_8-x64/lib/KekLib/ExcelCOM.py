...
class ExcelComClient:
    ...
    def merge_books( self, input_books, merged_book, progress_cb=None, merged_cb=None ):
...
def merge_into_a_book( input_books, merged_book, excel_client=None, progress_cb=None ):
    ...
    """
    excel_client_.merge_books( input_books, merged_book, progress_cb=progress_cb )
