...
"""
    ...
    Copyright (c) 2017-2019, Masatsuyo Takahashi

"""
import os

from OurTkinter         import Tk, FileDialog, TkDND, is_empty_val
try:
...
class FileNodeEntry( Tk.Frame ):
    def __init__( self, parent, **kw ):
        ...
        if var is None:
            ...
            kw['textvariable'] = var
        self.variable = var
        self.on_entry_cb = kw.get( 'on_entry_cb' )
    ...
    def add_dnd_bind( self ):
        ...
        self.dnd.bindtarget( self.entry, dnd_handler, 'text/uri-list' )
